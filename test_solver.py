from utilities import is_solution_valid, create_sudoku_from_2d_list, create_2d_list_from_sudoku
from AC3_new import ac3
...
#     sudoku1 = [[None,None,None,2,6,None,7,None,1],
...
#     sudoku_grid1 = create_sudoku_from_2d_list(sudoku1)
#     ac3(sudoku_grid1)
#     sudoku_tmp = create_2d_list_from_sudoku(sudoku_grid1)
